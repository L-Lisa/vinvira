...
export default function Webb() {
  ...
  return (
    <>
      ...
      {/* CTA Section */}
      <section className="relative overflow-hidden max-w-4xl mx-auto px-4 sm:px-6 py-16 sm:py-20 text-center rounded-3xl bg-gradient-to-r from-vin-primary-600 to-vin-secondary-600">
        <motion.h2 
          initial={{opacity:0, y:20}} 
          whileInView={{opacity:1, y:0}} 
          transition={{duration:0.6}}
      ...
      <PrisPaket 
        className="max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-20 bg-vin-neutral-50"
        showTitle={true}
